...
async function At2luogu() {
    ...
    if (getProblemId() && result) {
        const problemLink = $(`<li><a href="https://www.luogu.com.cn/problem/AT_${getProblemId()}" target="_blank" rel="noopener"><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Luogu</a></li>`)
            .attr("id", "problemLink")
            .attr("href", url)
            .attr("target", "_blank")
        ...
        problemLink.appendTo('.nav.nav-tabs');
    }
}
